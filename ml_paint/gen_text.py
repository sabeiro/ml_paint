...
opt = {"sequence_length":100,"batch_size":128,"n_epoch":30,"baseDir":baseDir+"/text/","cName":"markdown","fName":baseDir+"text/"+cName+".txt","isLoad":True,"genCoding":False}
